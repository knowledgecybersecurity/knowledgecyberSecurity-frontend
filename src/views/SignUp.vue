                     ...
                     <v-card-text>
                        <v-form>
                           ...
                           <v-text-field
                              ...
                              type="text"
                              v-model="userRegister.secretQuestion"
                           ></v-text-field>
                           <v-text-field
                              name="secretAnswer"
                              label="Secret Answer"
                              type="text"
                              v-model="userRegister.secretAnswer"
                           ></v-text-field>
                           <v-text-field
                              prepend-icon="lock"
                              name="Password"
    ...
    methods:{
        onSignUp(){
            const userToSignUp = {
                ...
                secretQuestion: this.userRegister.secretQuestion,
                secretAnswer: this.userRegister.secretAnswer
            }
        ...
        disableSignUp() {
            if (this.userRegister.firstName.trim() === "" || 
                ...
                this.userRegister.secretQuestion.trim() === "" ||
                this.userRegister.secretAnswer.trim() === ""
